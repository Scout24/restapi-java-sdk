...
public class ApartmentBuyFacade implements ApartmentFacade {
	ApartmentBuy realestate;

	public ApartmentBuyFacade(ApartmentBuy realestate) {
		this.realestate = realestate;
	}

	@Override
	public ApartmentBuy get() {
		return realestate;
	}
