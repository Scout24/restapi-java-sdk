...
public class LivingBuySiteFacade implements SiteFacade {
	final private LivingBuySite realestate;

	public LivingBuySiteFacade(LivingBuySite realestate) {
		this.realestate = realestate;
	}

	public LivingBuySite get() {
		return realestate;
	}
