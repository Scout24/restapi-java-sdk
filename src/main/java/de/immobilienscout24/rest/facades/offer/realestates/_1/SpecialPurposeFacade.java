...
public class SpecialPurposeFacade implements CommercialFacade {
	final private SpecialPurpose realestate;

	public SpecialPurposeFacade(SpecialPurpose SpecialPurpose) {
		realestate = SpecialPurpose;
	}
