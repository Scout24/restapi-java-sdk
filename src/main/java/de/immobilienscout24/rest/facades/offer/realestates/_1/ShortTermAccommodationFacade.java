...
public class ShortTermAccommodationFacade implements RealestateFacade, EnergySavingFacade {
	final private ShortTermAccommodation realestate;

	public ShortTermAccommodationFacade(ShortTermAccommodation room) {
		realestate = room;
	}

	public ShortTermAccommodation get() {
		return realestate;
	}
