...
public class IS24ApiImpl implements Is24Api, InternalObjectApi {
  ...
  public String createRealestate(String username, String xml) {
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + username + "/realestate/" + "?usenewenergysourceenev2014values=true");
  ...
  public String updateRealestate(String username, String realestateId, String xml) {
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + username + "/realestate/" + encodeId(realestateId) +
  ...
  public List<String> getAllAttachmentIds(String username, String realestateId) {
    ...
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + username + "/realestate/" + encodeId(realestateId) + "/attachment");
  ...
  public List<RealEstate> getAllRealestates(String username, int pageSize, int pageNumber, boolean includeArchived) {
    ...
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + encodeUserName(username) + "/realestate?pagesize=" + pageSize + "&pagenumber=" +
      pageNumber + "&archivedobjectsincluded=" +
    ...
    @SuppressWarnings("unchecked")
    List<Element> children = ((Element) xmlRootElement.getChildren("realEstateList").get(0)).getChildren(
      "realEstateElement");
  ...
  public void publishRealestate(String realestateId, String publishChannelId) {
    String xml =
      "<common:publishObject xmlns:xlink=\"http://www.w3.org/1999/xlink\" xmlns:common=\"http://rest.immobilienscout24.de/schema/common/1.0\">" +
      NL + "<realEstate id=\"" +
  ...
  public String updateRealestateProject(String username, RealEstateProject realestateProject) {
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + username + "/realestateproject/" + realestateProject.getId() + "/" +
      "?usenewenergysourceenev2014values=true");
  ...
  @Override
  public void addRealestatesToRealestateProject(String username, String realestateProjectId,
                                                RealEstateProjectEntries realEstateProjectEntries) {
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + username + "/realestateproject/" + realestateProjectId +
  ...
  @Override
  public void addRealestatesToRealestateProject(String realestateProjectId,
                                                RealEstateProjectEntries realEstateProjectEntries) {
  ...
  @Override
  public void deleteRealestatesFromRealestateProject(String username, String realestateProjectId,
                                                     List<RealEstate> realEstates) {
    for (RealEstate realEstate : realEstates) {
  ...
  @Override
  public void deleteRealestateFromRealestateProject(String username, String realestateProjectId,
  ...
  public void deleteRealestateFromRealestateProject(String username, String realestateProjectId, ObjectId id) {
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + username + "/realestateproject/" + realestateProjectId +
      "/realestateprojectentry/" + id.getId());
  ...
  public void placeOnTopProduct(String username, ObjectId id, OnTopPlacement placement) {
    URL url = createURL(
      baseUrl + "/offer/v1.0/user/" + username + "/realestate/" + encodeId(id.getId()) + "/" + placement.getName() +
      "/");
