...
/**
 * Elemente f�r Spezialgewerbe-Objekte wie z.B. Bauernhof, Werkstatt oder
 * Gewerbepark.
 * 
 * <p>
 * Java-Klasse f�r OfferSpecialPurpose complex type.
 * 
 * <p>
...
@XmlType(name = "OfferSpecialPurpose", propOrder = { "commercializationType", "price", "calculatedPrice", "totalFloorSpace", "netFloorSpace", "minDivisible", "courtage", "specialPurposeType" })
public class OfferSpecialPurpose extends OfferRealEstateForList {
	...
	/**
	 * Ruft den Wert der specialPurposeType-Eigenschaft ab.
	 * 
	...
	/**
	 * Legt den Wert der specialPurposeType-Eigenschaft fest.
	 * 
	 * @param value
