...
/**
 * Eigenschaften f�r den Immobilientyp Industrie (Hallen/Produktion)
 * 
 * <p>
 * Java-Klasse f�r Industry complex type.
 * 
 * <p>
...
@XmlType(name = "Industry", propOrder = { "industryType", "areaDivisibleFrom", "plotArea", "hallHeight", "flooringType", "ramp", "lift", "autoLift", "goodsLift", "goodsLiftLoad", "craneRunway",
		"craneRunwayLoad", "floorLoad", "connectedLoad", "deposit", "energyCertificate", "commercializationType", "price", "calculatedPrice", "totalFloorSpace", "netFloorSpace", "minDivisible",
		"courtage", "distanceToMRS", "distanceToFM", "distanceToPT", "distanceToAirport", "condition", "numberOfParkingSpaces", "parkingSpacePrice", "lastRefurbishment", "interiorQuality",
		"constructionYear", "constructionYearUnknown", "freeFrom", "heatingType", "heatingTypeEnev2014", "firingTypes", "energySourcesEnev2014", "thermalCharacteristic",
		"energyConsumptionContainsWarmWater", "buildingEnergyRatingType", "additionalArea", "numberOfFloors", "additionalCosts" })
public class Industry extends RealEstate {
	...
	/**
	 * Ruft den Wert der industryType-Eigenschaft ab.
	 * 
	 * @return possible object is {@link IndustryType }
	 * 
	 */
	...
	/**
	 * Legt den Wert der industryType-Eigenschaft fest.
	 * 
	 * @param value
	 *            allowed object is {@link IndustryType }
	 * 
	 */
	...
	/**
	 * Ruft den Wert der craneRunway-Eigenschaft ab.
	 * 
	 * @return possible object is {@link YesNotApplicableType }
	 * 
	 */
	...
	/**
	 * Legt den Wert der craneRunway-Eigenschaft fest.
	 * 
	 * @param value
	 *            allowed object is {@link YesNotApplicableType }
	 * 
	...
	/**
	 * Ruft den Wert der craneRunwayLoad-Eigenschaft ab.
	 * 
	 * @return possible object is {@link Double }
	 * 
	 */
	...
	/**
	 * Legt den Wert der craneRunwayLoad-Eigenschaft fest.
	 * 
	 * @param value
	 *            allowed object is {@link Double }
	 * 
	...
	/**
	 * Ruft den Wert der connectedLoad-Eigenschaft ab.
	 * 
	...
	/**
	 * Legt den Wert der connectedLoad-Eigenschaft fest.
	 * 
	 * @param value
