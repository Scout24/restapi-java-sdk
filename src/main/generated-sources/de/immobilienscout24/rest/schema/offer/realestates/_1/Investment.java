...
/**
 * Eigenschaften f�r den Immobilientyp "Anlage" (Investment)
 * 
 * <p>
 * Java-Klasse f�r Investment complex type.
 * 
 * <p>
...
@XmlType(name = "Investment", propOrder = { "price", "industrialArea", "plotArea", "netFloorSpace", "investmentType", "energyPerformanceCertificate", "courtage", "totalFloorSpace", "livingSpace",
		"pricePerSQM", "priceMultiplier", "rentalIncomeActual", "rentalIncomeTarget", "otherCosts", "listed", "lift", "energyCertificate", "distanceToMRS", "distanceToFM", "distanceToPT",
		"distanceToAirport", "condition", "numberOfParkingSpaces", "parkingSpacePrice", "lastRefurbishment", "interiorQuality", "constructionYear", "constructionYearUnknown", "freeFrom",
		"heatingType", "heatingTypeEnev2014", "firingTypes", "energySourcesEnev2014", "thermalCharacteristic", "energyConsumptionContainsWarmWater", "buildingEnergyRatingType", "additionalArea",
		"numberOfFloors", "additionalCosts" })
public class Investment extends RealEstate {
	 ...
	 * 
	 * @return possible object is {@link InvestmentType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link InvestmentType }
	 * 
	 */
