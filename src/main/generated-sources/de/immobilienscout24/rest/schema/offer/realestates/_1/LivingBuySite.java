...
/**
 * Eigenschaften f�r den Immobilientyp "Wohngrundst�ck zum Kauf"
 * 
 * <p>
 * Java-Klasse f�r LivingBuySite complex type.
 * 
 * <p>
...
@XmlType(name = "LivingBuySite", propOrder = { "commercializationType", "recommendedUseTypes", "tenancy", "price", "plotArea", "minDivisible", "courtage", "freeFrom", "shortTermConstructible",
		"buildingPermission", "demolition", "siteDevelopmentType", "siteConstructibleType", "grz", "gfz", "leaseInterval" })
public class LivingBuySite extends RealEstate {
