...
/**
 * Eigenschaften f�r den Immobilientyp Spezialgewerbe
 * 
 * <p>
 * Java-Klasse f�r SpecialPurpose complex type.
 * 
 * <p>
...
@XmlType(name = "SpecialPurpose", propOrder = { "specialPurposePropertyType", "areaDivisibleFrom", "plotArea", "listed", "lift", "basement", "flooringType", "deposit", "energyCertificate",
		"commercializationType", "price", "calculatedPrice", "totalFloorSpace", "netFloorSpace", "minDivisible", "courtage", "distanceToMRS", "distanceToFM", "distanceToPT", "distanceToAirport",
		"condition", "numberOfParkingSpaces", "parkingSpacePrice", "lastRefurbishment", "interiorQuality", "constructionYear", "constructionYearUnknown", "freeFrom", "heatingType",
		"heatingTypeEnev2014", "firingTypes", "energySourcesEnev2014", "thermalCharacteristic", "energyConsumptionContainsWarmWater", "buildingEnergyRatingType", "additionalArea", "numberOfFloors",
		"additionalCosts" })
public class SpecialPurpose extends RealEstate {
	 ...
	 * 
	 * @return possible object is {@link SpecialPurposeType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link SpecialPurposeType }
	 * 
	 */
