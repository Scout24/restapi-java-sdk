...
/**
 * Eigenschaften f�r den Haus-Miete Immobilientyp
 * 
 * <p>
 * Java-Klasse f�r HouseRent complex type.
 * 
 * <p>
...
@XmlType(name = "HouseRent", propOrder = { "price", "livingSpace", "plotArea", "numberOfRooms", "energyPerformanceCertificate", "courtage", "buildingType", "energyCertificate", "cellar",
		"handicappedAccessible", "numberOfParkingSpaces", "condition", "lastRefurbishment", "interiorQuality", "constructionYear", "constructionYearUnknown", "freeFrom", "heatingType",
		"heatingTypeEnev2014", "firingTypes", "energySourcesEnev2014", "buildingEnergyRatingType", "thermalCharacteristic", "energyConsumptionContainsWarmWater", "numberOfFloors", "usableFloorSpace",
		"numberOfBedRooms", "numberOfBathRooms", "guestToilet", "parkingSpaceType", "baseRent", "totalRent", "serviceCharge", "deposit", "heatingCosts", "heatingCostsInServiceCharge", "petsAllowed",
		"parkingSpacePrice", "useAsFlatshareRoom", "builtInKitchen" })
public class HouseRent extends RealEstate {
	 ...
	 * 
	 * @return possible object is {@link BuildingType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link BuildingType }
	 * 
	 */
