...
/**
 * Eigenschaften f�r den Haus-Kauf Immobilientyp
 * 
 * <p>
 * Java-Klasse f�r HouseBuy complex type.
 * 
 * <p>
...
@XmlType(name = "HouseBuy", propOrder = { "lodgerFlat", "constructionPhase", "buildingType", "energyCertificate", "cellar", "handicappedAccessible", "numberOfParkingSpaces", "condition",
		...
		"buildingEnergyRatingType", "thermalCharacteristic", "energyConsumptionContainsWarmWater", "numberOfFloors", "usableFloorSpace", "numberOfBedRooms", "numberOfBathRooms", "guestToilet",
		"parkingSpaceType", "rented", "rentalIncome", "listed", "parkingSpacePrice", "summerResidencePractical", "price", "livingSpace", "plotArea", "numberOfRooms", "energyPerformanceCertificate",
		"courtage" })
public class HouseBuy extends RealEstate {
	...
	/**
	 * Ruft den Wert der lodgerFlat-Eigenschaft ab.
	 * 
	...
	/**
	 * Legt den Wert der lodgerFlat-Eigenschaft fest.
	 * 
	 * @param value
	...
	/**
	 * Ruft den Wert der constructionPhase-Eigenschaft ab.
	 * 
	 * @return possible object is {@link ConstructionPhaseType }
	 * 
	 */
	...
	/**
	 * Legt den Wert der constructionPhase-Eigenschaft fest.
	 * 
	 * @param value
	 *            allowed object is {@link ConstructionPhaseType }
	 * 
	 */
