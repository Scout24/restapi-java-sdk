 ...
 * 
 * <p>
 * Java-Klasse f�r RealEstate complex type.
 * 
 * <p>
...
@XmlType(name = "RealEstate", propOrder = { "showAddress", "contact", "publishChannels" })
@XmlSeeAlso({ Office.class, SpecialPurpose.class, LivingRentSite.class, Store.class, GarageRent.class, Gastronomy.class, ApartmentBuy.class, HouseBuy.class, GarageBuy.class, Investment.class,
		FlatShareRoom.class, ApartmentRent.class, CompulsoryAuction.class, LivingBuySite.class, SeniorCare.class, HouseType.class, ShortTermAccommodation.class, Industry.class, AssistedLiving.class,
		TradeSite.class, HouseRent.class })
public abstract class RealEstate extends AbstractRealEstate {
	 ...
	 * 
	 * @return possible object is {@link RealEstate.Contact }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link RealEstate.Contact }
	 * 
	 */
