 ...
 *       &lt;sequence>
 *         &lt;element name="entitlement" type="{http://rest.immobilienscout24.de/schema/entitlement/1.0}entitlement" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "userEntitlementsResponse")
public class UserEntitlementsResponse {
    ...
    public List<Entitlement> getEntitlement() {
        if (entitlement == null) {
            entitlement = new ArrayList<Entitlement>();
        }
