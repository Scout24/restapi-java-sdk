...
public enum MessageCode {
	...
	/**
	 * Validation according the schema failed (includes the description of the
	 * failure).
	 * 
	 */
	...
	/**
	 * A required parameter is missing in the request (contains the name of the
	 * parameter).
	 * 
	 */
	...
	/**
	 * At least one request parameter contains an invalid value (contains the
	...
	/**
	 * The resource is not supported within the context of the request (includes
	 * name of the unauthorized and unavailable resource e.g. savedsearch is
	 * only for searchers).
	 * 
	 */
	...
	/**
	 * Not all of the data for the resource are valid (includes the description
	 * of the failure).
	 * 
	 */
