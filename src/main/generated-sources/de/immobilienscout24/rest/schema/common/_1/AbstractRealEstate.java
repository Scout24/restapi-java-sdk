...
/**
 * Allgemeine Elemente f�r alle Immobilienarten im Expose.
 * 
 * 
 * <p>
 * Java-Klasse f�r AbstractRealEstate complex type.
 * 
 * <p>
...
@XmlType(name = "AbstractRealEstate", propOrder = { "groupNumber", "descriptionNote", "furnishingNote", "locationNote", "otherNote", "attachments", "referencePriceServiceCall",
		"referencePriceApiCall" })
@XmlSeeAlso({ RealEstate.class })
public abstract class AbstractRealEstate extends AbstractRealEstateForList {
	 ...
	 * 
	 * @return possible object is {@link Attachments }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Attachments }
	 * 
	 */
